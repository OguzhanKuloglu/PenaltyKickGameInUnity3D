...
// View`1<System.Object>
struct View_1_tBA8146540E028CF9261DF2B9B8385668E1F1B39E  : public Singleton_1_t761811FA61B8CEAEB90FA0D60BD999994A7FE1E6
{
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void View_1_Awake_m6DDA0F7D1B48B53E9802BC178F5FD80FC548B185_gshared (View_1_tBA8146540E028CF9261DF2B9B8385668E1F1B39E* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->___m_GameManager_11 = L_0;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___m_GameManager_11), (void*)L_0);
		// m_Visible = false;
		__this->___m_Visible_10 = (bool)0;
		// m_Group.alpha = 0.0f;
		CanvasGroup_t048C1461B14628CFAEBE6E7353093ADB04EBC094* L_1 = (CanvasGroup_t048C1461B14628CFAEBE6E7353093ADB04EBC094*)__this->___m_Group_9;
		NullCheck(L_1);
		CanvasGroup_set_alpha_m5C06839316D948BB4F75ED72C87FA1F1A20C333F(L_1, (0.0f), NULL);
		// m_Group.interactable = false;
		CanvasGroup_t048C1461B14628CFAEBE6E7353093ADB04EBC094* L_2 = (CanvasGroup_t048C1461B14628CFAEBE6E7353093ADB04EBC094*)__this->___m_Group_9;
		NullCheck(L_2);
		CanvasGroup_set_interactable_m86928BB0894EF3F06BC7BE63594272FBA0DAC757(L_2, (bool)0, NULL);
		// m_Group.blocksRaycasts = false;
		CanvasGroup_t048C1461B14628CFAEBE6E7353093ADB04EBC094* L_3 = (CanvasGroup_t048C1461B14628CFAEBE6E7353093ADB04EBC094*)__this->___m_Group_9;
		NullCheck(L_3);
		...
		GameManager_tFE129A0017AF5BBD30FDCD4403B9CCEAE064C6B6* L_4 = (GameManager_tFE129A0017AF5BBD30FDCD4403B9CCEAE064C6B6*)__this->___m_GameManager_11;
		OnGamePhaseChanged_t6D2F1C2B8E5D25CB30667D0AF63B09AA4E0CC4A1* L_5 = (OnGamePhaseChanged_t6D2F1C2B8E5D25CB30667D0AF63B09AA4E0CC4A1*)il2cpp_codegen_object_new(OnGamePhaseChanged_t6D2F1C2B8E5D25CB30667D0AF63B09AA4E0CC4A1_il2cpp_TypeInfo_var);
		NullCheck(L_5);
		OnGamePhaseChanged__ctor_m681D72890F4F6868B7FED8B3886489A0279DF987(L_5, (RuntimeObject*)__this, (intptr_t)((void*)GetVirtualMethodInfo(__this, 6)), NULL);
		NullCheck(L_4);
		GameManager_add_onGamePhaseChanged_m939E0C75F935F0F1201302754A2C673D9B8A24C7(L_4, L_5, NULL);
		// }
		return;
	}
}
...
{
	View_1_tBA8146540E028CF9261DF2B9B8385668E1F1B39E* G_B2_0 = NULL;
	View_1_tBA8146540E028CF9261DF2B9B8385668E1F1B39E* G_B1_0 = NULL;
	float G_B3_0 = 0.0f;
	View_1_tBA8146540E028CF9261DF2B9B8385668E1F1B39E* G_B3_1 = NULL;
	{
		// m_Visible = _InOrOut;
		bool L_0 = ____InOrOut0;
		__this->___m_Visible_10 = L_0;
		// m_StartTime = Time.time;
		float L_1;
		L_1 = Time_get_time_m0BEE9AACD0723FE414465B77C9C64D12263675F3(NULL);
		__this->___m_StartTime_12 = L_1;
		// m_InTransition = true;
		__this->___m_InTransition_14 = (bool)1;
		// m_InOrOut = _InOrOut;
		bool L_2 = ____InOrOut0;
		__this->___m_InOrOut_15 = L_2;
		// m_Duration = _InOrOut ? m_FadeInDuration : m_FadeOutDuration;
		bool L_3 = ____InOrOut0;
		G_B1_0 = __this;
		if (L_3)
		{
			G_B2_0 = __this;
	...
	{
		float L_4 = (float)__this->___m_FadeOutDuration_8;
		G_B3_0 = L_4;
		G_B3_1 = G_B1_0;
		goto IL_0032;
	}
...
IL_002c:
	{
		float L_5 = (float)__this->___m_FadeInDuration_7;
		G_B3_0 = L_5;
		G_B3_1 = G_B2_0;
	}
...
IL_0032:
	{
		NullCheck(G_B3_1);
		G_B3_1->___m_Duration_13 = G_B3_0;
		// m_Group.interactable = false;
		CanvasGroup_t048C1461B14628CFAEBE6E7353093ADB04EBC094* L_6 = (CanvasGroup_t048C1461B14628CFAEBE6E7353093ADB04EBC094*)__this->___m_Group_9;
		NullCheck(L_6);
		CanvasGroup_set_interactable_m86928BB0894EF3F06BC7BE63594272FBA0DAC757(L_6, (bool)0, NULL);
		// m_Group.blocksRaycasts = false;
		CanvasGroup_t048C1461B14628CFAEBE6E7353093ADB04EBC094* L_7 = (CanvasGroup_t048C1461B14628CFAEBE6E7353093ADB04EBC094*)__this->___m_Group_9;
		NullCheck(L_7);
...
// System.Void View`1<System.Object>::Update()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void View_1_Update_mA95991D878CDC109846EBE4232BFD85EAB8C65D1_gshared (View_1_tBA8146540E028CF9261DF2B9B8385668E1F1B39E* __this, const RuntimeMethod* method) 
{
	float V_0 = 0.0f;
	...
	{
		// if (m_InTransition)
		bool L_0 = (bool)__this->___m_InTransition_14;
		if (!L_0)
		{
			goto IL_008d;
		}
	}
	{
		...
		float L_1;
		L_1 = Time_get_time_m0BEE9AACD0723FE414465B77C9C64D12263675F3(NULL);
		float L_2 = (float)__this->___m_StartTime_12;
		// float percent = time / m_Duration;
		float L_3 = (float)__this->___m_Duration_13;
	...
	}
	{
		...
		CanvasGroup_t048C1461B14628CFAEBE6E7353093ADB04EBC094* L_5 = (CanvasGroup_t048C1461B14628CFAEBE6E7353093ADB04EBC094*)__this->___m_Group_9;
		bool L_6 = (bool)__this->___m_InOrOut_15;
		G_B3_0 = L_5;
		if (L_6)
		{
			G_B4_0 = L_5;
...
IL_0045:
	{
		...
		__this->___m_InTransition_14 = (bool)0;
		// m_Group.alpha = m_InOrOut ? 1.0f : 0.0f;
		CanvasGroup_t048C1461B14628CFAEBE6E7353093ADB04EBC094* L_9 = (CanvasGroup_t048C1461B14628CFAEBE6E7353093ADB04EBC094*)__this->___m_Group_9;
		bool L_10 = (bool)__this->___m_InOrOut_15;
		G_B7_0 = L_9;
		if (L_10)
		{
			G_B8_0 = L_9;
...
IL_0066:
	{
		...
		CanvasGroup_t048C1461B14628CFAEBE6E7353093ADB04EBC094* L_11 = (CanvasGroup_t048C1461B14628CFAEBE6E7353093ADB04EBC094*)__this->___m_Group_9;
		bool L_12 = (bool)__this->___m_InOrOut_15;
		NullCheck(L_11);
		CanvasGroup_set_interactable_m86928BB0894EF3F06BC7BE63594272FBA0DAC757(L_11, L_12, NULL);
		// m_Group.blocksRaycasts = m_InOrOut;
		CanvasGroup_t048C1461B14628CFAEBE6E7353093ADB04EBC094* L_13 = (CanvasGroup_t048C1461B14628CFAEBE6E7353093ADB04EBC094*)__this->___m_Group_9;
		bool L_14 = (bool)__this->___m_InOrOut_15;
		NullCheck(L_13);
...
{
	{
		...
		__this->___m_FadeInDuration_7 = (0.300000012f);
		// public float m_FadeOutDuration = 0.3f;
		__this->___m_FadeOutDuration_8 = (0.300000012f);
		il2cpp_codegen_runtime_class_init_inline(il2cpp_rgctx_data(method->klass->rgctx_data, 2));
		((  void (*) (Singleton_1_t761811FA61B8CEAEB90FA0D60BD999994A7FE1E6*, const RuntimeMethod*))il2cpp_codegen_get_method_pointer(il2cpp_rgctx_method(method->klass->rgctx_data, 1)))((Singleton_1_t761811FA61B8CEAEB90FA0D60BD999994A7FE1E6*)__this, il2cpp_rgctx_method(method->klass->rgctx_data, 1));
		return;
	}
}
#ifdef __clang__
